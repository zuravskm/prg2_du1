    ...
    ColumnLayout {
        ...
        Map {
            ...
            Connections {
                ...
                onCurrentItemChanged: mapa.zoomLevel = 6 }
            ...
            MapItemView {
                ...
                delegate: MapQuickItem {
                        ...
                        sourceItem: Column {
                            Text {text: model.display; color: (model.mesto == 1) ? colorCity : colorVillage}
                            Image {
                                Rectangle {y: 18; width: 10; height: 10; radius: 5; color: (model.mesto == 1) ? colorCity : colorVillage }
                            }
                        }
