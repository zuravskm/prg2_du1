...
class Filter(QObject):
    ...
    def __init__(self): # inicializace 
        ...
        self._districts = [ "Kroměříž", "Uherské Hradiště", "Vsetín", "Zlín", "VŠE"]
        self._district = "Zlín"
...
class BrowserCityModel(QAbstractListModel):
    ...
    def data(self, index:QtCore.QModelIndex, role:int=...) -> typing.Any:
        ...
        if role == self.Roles.AREA.value:
            f = self.browser_city[index.row()]['properties']['SHAPE_Area']
            f_round = round(f)
            return f_round
